...
insert into bill_temp (code, date, client, paymentMethod, seller) values ("SALE001", "2025-01-15", "1234567890", "PAY001", "9876543210");
insert into bill_temp (code, date, client, paymentMethod, seller) values ("SALE002", "2025-02-20", "PEP2023456", "PAY002", "PS1234567");
insert into bill_temp (code, date, client, paymentMethod, seller) values ("SALE003", "2025-03-10", "CE9832471", "PAY003", "PEP2023456");
insert into bill_temp (code, date, client, paymentMethod, seller) values ("SALE004", "2025-04-05", "PEP9876543", "PAY004", "1029384756");
